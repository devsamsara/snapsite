# Sistema de Navegación con Menú Flotante - KaylonCam

## Resumen

Se ha rediseñado completamente el sistema de navegación de KaylonCam, reemplazando el tab bar tradicional por un **menú flotante** en la parte inferior con transiciones tipo **switch/segmented control**, similar a la app Cámara de iOS.
