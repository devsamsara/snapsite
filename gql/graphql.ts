...
export type FindProjectQuery = { __typename?: 'Query', findProject: { __typename?: 'Project', id: string, startDate: string, endDate?: string | null, progress: number, thumbnail?: string | null, createdAt: string, description: string, timeline?: Array<{ __typename?: 'TimelineEvent', createdAt: string, description: string, id: string, photoUrl?: string | null, title: string, type: TimelineEventType, updatedAt: string }> | null, members: Array<{ __typename?: 'User', id: string, name: string, role: UserRole }>, notes: Array<{ __typename?: 'Note', content: string, createdAt: string, id: string, pinned: boolean, updatedAt: string, author: { __typename?: 'User', id: string, name: string } }>, photos: Array<{ __typename?: 'Photo', createdAt: string, id: string, url: string, tags?: Array<string | null> | null }> } };
