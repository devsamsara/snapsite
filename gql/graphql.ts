...
export type DeleteProjectMutationVariables = { id: Scalars['ID']['input'] };
...
export type ArchiveProjectMutationVariables = { id: Scalars['ID']['input'], input: UpdateProjectInput };
